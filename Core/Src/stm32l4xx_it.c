...
/* Private variables ---------------------------------------------------------*/
/* USER CODE BEGIN PV */
// Set by HAL_GPIO_EXTI_Callback when BTN3 (PC3) fires; cleared by the game loop.
extern volatile uint8_t g_btn3_pressed;
/* USER CODE END PV */
...
/* USER CODE BEGIN 1 */
// Override the weak HAL callback to capture BTN3 (PC3, EXTI3) presses.
